...
const Interactive3DViewer: React.FC<Interactive3DViewerProps> = ({
  ...
  return (
    <div
      className={`w-full ${simple ? "" : "aspect-video"} flex flex-col rounded-lg overflow-hidden ${simple ? "" : "bg-adam-darker/50 border border-white/10"}`}
    >
              ...
              {colors.map((color) => (
                <button
                  ...
                  style={{
                    ...
                    outline:
                      cubeColor === color.value ? "2px solid white" : "none",
                  }}
